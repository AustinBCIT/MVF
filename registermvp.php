...
<head>
    ...
    function checkPassword() {
        ...
        var confirmPassword = document.getElementById('checkPass1').value;
 ...
 <nav id="menu" class="menu">
     <a href="mobileindex.html">
        <header class="menu-header">
          <span class="menu-header-title">Welcome to MVF</span>
        </header>
      </a>
...
<!-- jQuery slider -->      
    ...
    <div class="core-container">
            ...
            <div class="col-xs-12 col-md-12 title-container" class="headerBackground">
                <p class="virtual-char">Hello there, ready to make a difference?
